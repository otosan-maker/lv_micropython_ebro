...
class ili9XXX:
    ...
    def __init__(self,
        miso=19, mosi=23, clk=18, cs=15, dc=2, rst=4, power=-1, backlight=-1, backlight_on=0, power_on=0,
        spihost=esp.HSPI_HOST, mhz=28, factor=4, hybrid=True, width=240, height=320, start_x=0, start_y=0,
...
class ili9341(ili9XXX):
    ...
    def __init__(self,
        miso=19, mosi=23, clk=18, cs=15, dc=2, rst=4, power=-1, backlight=-1, backlight_on=0, power_on=0,
        spihost=esp.HSPI_HOST, mhz=28, factor=4, hybrid=True, width=320, height=240, start_x=0, start_y=0,
        colormode=COLOR_MODE_BGR, rot=-4, invert=False, double_buffer=True, half_duplex=True,
